...
INSERT INTO `questions` VALUES ('01101',0000001,'yosi','t+25=26 \nt=? \n1) -1   2) 1   3) 10   4) 0.5',0,1,0,0,'01'),('01102',0000002,'yosi','Which value of j makes (5+3)j=24*2 a true statement?\n1) j=3   2) j=4   3) j=5   4) j=6',0,0,0,1,'01'),('01103',0000003,'yosi','4 = t/2.5\nt=?\n1) 1   2) 2.5   3) 5   4) 10',0,0,0,1,'01'),('01104',0000004,'yosi','2x + 5 = 15\nx=?\n1) 5   2) 3   3) 1   4) 0',1,0,0,0,'01'),('01105',0000005,'yosi','x+3(x-1) = 7\nx=?\n1) 5.5   2) 7   3) 2.5   4) 10',0,0,1,0,'01');
...
CREATE TABLE `student_test` (
  ...
  `selectedExamType` varchar(15) NOT NULL,
  PRIMARY KEY (`users_userID`,`exams_examCode`,`selectedExamType`),
...
INSERT INTO `student_test` VALUES (1,'Completed',NULL,60,NULL,'good luck',1,'{01103=4, 01102=1, 01101=2, 01105=4, 01104=1}',1,'e111','computerized'),(0,'Completed',NULL,-1,NULL,NULL,1,'{}',1,'e222','Manual'),(1,'Done',NULL,100,NULL,'good luck',1,'{01103=4, 01102=4, 01101=2, 01105=3, 01104=1}',4,'e111','manual'),(1,'Done',NULL,100,NULL,'good luck',1,'{01103=4, 01102=4, 01101=2, 01105=3, 01104=1}',5,'e111','computerized');
...
CREATE TABLE `tests` (
  ...
  `remarksForStudents` varchar(256) DEFAULT NULL,
  `remarksForLecturer` varchar(256) DEFAULT NULL,
...
INSERT INTO `tests` VALUES ('010101',120,20,'You need to answer all questions.\nYou can only choose one answer.\nYou have to submit your exam before time is ended.','easy test','yosi',5,'01','01');
...
-- Dump completed on 2018-06-22 23:49:45
