...
e.g.
> "C:\Program Files\Java\jre1.8.0_151\bin\javaw.exe" -cp "G16_Server.jar;lib/mysql-connector-java-5.1.46-bin.jar" server.AEServer
...
e.g.
> "C:\Program Files\Java\jre1.8.0_151\bin\java.exe" -cp "G16_Client.jar;lib/*" application.AESystem 127.0.0.1
...
> java -cp "G16_Server.jar;lib/mysql-connector-java-5.1.46-bin.jar"

2) Same for client that is using other jars to deal with creating word document. include all jars under lib folder:
> java -cp "G16_Client.jar;lib/*"
